		...
		<footer className="bg-gradient-to-br from-gray-800 to-gray-900 text-white py-8 relative overflow-hidden">
			...
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
				<div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
					...
					<div className="md:col-span-2">
						<div className="flex items-center mb-4">
							...
							<div>
								...
								<p className="text-xs text-pink-400 font-medium">Since 2008</p>
							</div>
						</div>
					...
					{/* Products */}
					<div>
						<h3 className="text-sm font-semibold mb-3 text-pink-400">Products</h3>
						<ul className="space-y-2 text-sm text-gray-300">
							<li><Link href="/products/sterilization" className="hover:text-pink-400 transition-colors">Sterilization Indicators</Link></li>
					...
					{/* Company */}
					<div>
						<h3 className="text-sm font-semibold mb-3 text-pink-400">Company</h3>
						<ul className="space-y-2 text-sm text-gray-300">
					...
					<div className="flex flex-col sm:flex-row justify-between items-center gap-3">
						...
						<div className="flex items-center gap-4 text-xs text-gray-300">
							<span className="flex items-center">
								<svg className="w-3 h-3 text-pink-400 mr-1" fill="currentColor" viewBox="0 0 20 20">
